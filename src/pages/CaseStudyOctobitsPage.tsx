...
const imgBrilliantFacetedCrystalGemstone1 = `${assetPathPrefix}/83edd.webp`;
const imgDellXpsMockup = `${assetPathPrefix}/151fd.png`;
const imgDashboardWithTask1 = `${assetPathPrefix}/b99d7.webp`;
const imgDashboardWithTask2 = `${assetPathPrefix}/a9580.webp`;
const imgDashboardWithTask3 = `${assetPathPrefix}/51646.webp`;
const imgDashboardWithTask4 = `${assetPathPrefix}/889e3.webp`;
const imgDashboardWithTask5 = `${assetPathPrefix}/c5e6f.webp`;
const imgScreenViewport = `${assetPathPrefix}/93398.webp`;
const imgScreenViewport1 = `${assetPathPrefix}/ca5a2.webp`;
const imgScreenViewport2 = `${assetPathPrefix}/c5be1.webp`;
const imgScreenViewport3 = `${assetPathPrefix}/f1da7.webp`;
const imgScreenViewport4 = `${assetPathPrefix}/bef18.webp`;
